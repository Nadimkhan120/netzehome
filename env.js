 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.jobulus-candidate-app.staging
 */

const BUNDLE_ID = 'com.jobulus.candidate.pp'; // ios bundle id
const PACKAGE = 'com.jobulus.candidate.app'; // android package name
const NAME = 'candidate'; // app name
